...
impl State {
    ...
    pub fn viewed_year(&self) -> i32 {
        self.viewed_year
    }

    pub fn viewed_month(&self) -> u32 {
        self.viewed_month
    }
    ...
    pub fn get_one_way_date(&self) -> NaiveDate {
        self.one_way_date
    }
    ...
    pub fn get_round_trip_date(&self) -> NaiveDate {
        self.round_trip_date
    }
